...
A = [A11 A12; A21 A22];
B = [B11 B12; B21 B22];
fprintf('Ket qua phep tinh A11*B11 + A12*B21')
A11*B11 + A12*B21
fprintf('Ket qua phep tinh A11*B12 + A12*B22')
A11*B12 + A12*B22
fprintf('Ket qua phep tinh A21*B11 + A22*B21')
A21*B11 + A22*B21
fprintf('Ket qua phep tinh A21*B12 + A22*B22')
A21*B12 + A22*B22
fprintf('Ket qua phep tinh A*B')
A*B
