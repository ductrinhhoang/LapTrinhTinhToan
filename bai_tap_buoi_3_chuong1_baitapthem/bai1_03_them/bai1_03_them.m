function bai1_03_them()
    ...
    I = eye(3,3);
    B = A - 2*I;
    fprintf('1. B is a nilpotent matrix. So B^k = 0 for every k >= 3\n');
    fprintf(' \n');
    
    syms n;
    fprintf('2. A = 2I + B, we have\n');
    ...
    fprintf('\n5. Transform A^(x+y) in term of x and y, we can prove that \n');
    fprintf('F(x+y) = F(x)*F(y) \n');
end